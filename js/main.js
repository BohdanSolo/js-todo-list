...
- Коли справа checked, тоді зробити innerHTML перекресленим
- Додати справу у вьорстку і стилізувати її
- Додати можливіст редагування таску
- Можливо дадати хрестик для видаленя таску
*/
